...
<div class="root" class:mounted>
	...
	<main class="page" class:mounted>
		<div class="page-header">
			...
			<div class="hero-label">Builder</div>
			
			<div class="name-editor">
				<input class="name-input" bind:value={rubricName} placeholder="New Rubric Name..." />
				<button class="save-master-btn" onclick={createRubric}>Create Rubric</button>
			</div>
		</div>
